        ...
        {windowWidth > 1024 && (
          <Box>
            ...
            >
              ...
              <Box>
                <Text fontSize="13px">Chọn cửa hàng</Text>
              </Box>
            </Box>
      ...
      {scrollPosition > 100 && <NavSearch/>}
        ...
        <Link className="hover_green">
          <Box display="flex" fontSize="14px">
            ...
            {windowWidth > 1104 && <Box mt="2px" fontWeight="600">Ưu đãi</Box>}
            {windowWidth < 1024 && windowWidth > 650 && <Box mt="2px" fontWeight="600" >Ưu đãi</Box>}
          </Box>
        </Link>
        <Link className="hover_green" to={"/cart"}>
          <Box display="flex" fontSize="14px" pos={"relative"}>
            ...
            {windowWidth > 1104 && <Box mt="2px" fontWeight="600">Giỏ hàng</Box>}
            {windowWidth < 1024 && windowWidth > 650 && <Box fontWeight="600" mt="2px">Giỏ hàng</Box>}
          </Box>
        </Link>
      </Flex>
          ...
          >
            <Box display="flex">
              ...
              <Box fontSize="13px" ml="15px" display="flex" flexDir="column" justifyContent="space-between" color="white">
                <Box fontSize="15px">Xin chào bạn!</Box>
