  ...
  return (
    <Flex  width="80%" margin="30px auto"  justify={{base:"center",sm:"center",lg:"space-between",xl:"space-between"}} flexDir={{base:"column",sm:"column",lg:"row",xl:"row"}} >
        <Box flexGrow={"1"} maxW={"700px"}>
           <HStack width={"100%"} justify={"space-between"}><Text fontSize={"26px"} fontWeight="600" mb={"15px"}>Sản phẩm trong giở</Text><Text fontSize={"12px"}>Giá chỉ mang tính chất hiển thị</Text></HStack>
            <CartStack/>
        </Box>
        <Box minW={"300px"} p={4}>
            <OrderSummary/>
